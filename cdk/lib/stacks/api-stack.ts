...
export interface UapiUstackProps extends cdk.StackProps {
...
export class UapiUstack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: UapiUstackProps) {
